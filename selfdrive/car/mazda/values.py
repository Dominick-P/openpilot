...
FW_VERSIONS = {
  ...
  CAR.MAZDA3_2019 : {
    (Ecu.eps, 0x730, None): [
      b'BDGF-3216X-C\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00', # 2022 CE SEDAN FWD EXISTING
    ...
    (Ecu.engine, 0x7e0, None): [
      b'PXJD-188K2-B\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00', # 2022 CE SEDAN FWD
    ...
    (Ecu.fwdRadar, 0x764, None): [
      b'BDTS-67XK2-E\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00', # 2022 CE SEDAN FWD EXISTING
    ...
    (Ecu.abs, 0x760, None): [
      b'BGLR-4300F-A\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00', # 2022 CE SEDAN FWD
